...
┗━━°:🎧:°━━┛`,
            ...
            case 'ytmp3': {
                ...
                let buttonMessage = {
                    caption: `*Selected Your Type*
                    
                    _Developerd By Sadeesha_`,
                    footer: GojoMdNx.user.name,
                    buttons: buttons,
                    headerType: 4
                }
	    ...
	    case 'audio': {
                ...
                GojoMdNx.sendButtonText({buttonId: `owner ${anu.url}`, buttonText: {displayText: '🍇ටැන්කූ සදීෂ🍇'}, type: 1}, caption `*🎧 Title :* _${media.title}_\n🎭 *File Size :* _${media.filesizeF}_\n*✒️ Url :* _${isUrl(text)}_\n*💎 Ext :* _MP3_\n*🪄 Resolution :* ${args[1] || '320kbps'}`, m)
            ...
            case 'ytmp4': {
                let buttons = [
                    {buttonId: `audio ${anu.url}`, buttonText: {displayText: '►360p►'}, type: 1},
                    {buttonId: `document ${anu.url}`, buttonText: {displayText: '►480p►'}, type: 1},
                    {buttonId: `document ${anu.url}`, buttonText: {displayText: '►720p►'}, type: 1},
                ]
                let buttonMessage = {
                    caption: `*Selected Your Type*
