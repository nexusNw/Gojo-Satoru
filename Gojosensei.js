...
🔗 *Media Url* : ${images}`,
	    ...
	    case 'play': case 'song': case 'ytplay': {
                ...
                let buttons = [
                    ...
                    {buttonId: `ytmp4 ${anu.url}`, buttonText: {displayText: '►480'}, type: 1},
                    {buttonId: `ytmp4 ${anu.url}`, buttonText: {displayText: '►720'}, type: 1},
                    {buttonId: `ytmp4 ${anu.url}`, buttonText: {displayText: 'Thanks Sadiyo'}, type: 1},                    
                ]
                let buttonMessage = {
