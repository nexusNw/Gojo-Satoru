		...
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'antilink': {
                ...
                reply(`Antilink Inactive !`)
                 ...
                 let buttons = [
                        { buttonId: 'antilink on', buttonText: { displayText: 'ඔන්✅' }, type: 1 },
                        { buttonId: 'antilink off', buttonText: { displayText: 'ඕප්❌' }, type: 1 }
                    ]
...
hydratedTemplate: {
 ...
 hydratedFooterText: `ආදරෙයි මැනික.....❤️‍
...
└┬──────────────┈ ⳹
   ...
   └───────────────┈ ⳹`,
                ...
                break
                case 'command': case 'alpha': {
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `හලෝ මැණික😙 ${pushname}`,
                    description: `🫐විධාන ලැයිස්තුව භාවිත කරන්න🫐\n\n`,
                    buttonText: "🍇sᴀᴅɪʏᴀ🍇",
								...
								"rows": [
									{
										...
										"description": "බොට් හිමිකරුගෙ ලැයිස්තුව !!",
										"rowId": `${prefix}tqtt`
									}
								]
							}
