...
✑ No te olvides de leerlas reglas del grupo hee para asegurar tu estadia!!`} )
                } else if (anu.action == 'remove') {
                    GojoMdNx.sendMessage(anu.id, { image: Tol, contextInfo: { mentionedJid: [num] }, caption: `✑ @${num.split("@")[0]} Adiós ${metadata.subject}
