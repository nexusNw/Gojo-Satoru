...
async function startGojoMdNx() {
    ...
    // Get Profile Picture Group
       ...
       GojoMdNx.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\n*කණ්ඩායම් Chat Mute විය....🔇* (🔥ᴍɪɴ ᴛᴇᴄʜ ₂₀₂₂)`, `Group Settings Change Message`, wm_fatih, [])
       } else if(pea[0].announce == false) {
       GojoMdNx.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\n*කණ්ඩායම්  Chat Unmute විය....🔊* (🔥ᴍɪɴ ᴛᴇᴄʜ ₂₀₂₂)`, `Group Settings Change Message`, wm_fatih, [])
